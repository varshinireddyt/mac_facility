...
<center><h2>Reservation List</h2></center>
       ...
       <table align="center" border="1" class="myTable"> 
 		...
 		<c:forEach items="${RESERVATIONS}" var="item" varStatus="status">
            ...
            <td> <a href="/company_management/ReservationController?action=ViewMYSpecificViolation&idreservation=${item.idreservation}">View</a></td>
			</tr>
		</c:forEach>
 </table>
...
<a href="<%=request.getContextPath()%>/user.jsp" style="float:left">Back</a>
