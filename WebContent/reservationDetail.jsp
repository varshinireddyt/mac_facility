...
<div style="text-align:center">
	<form action="<%=request.getContextPath()%>/modifyReservation.jsp">
		<input type="submit" value="Modify">
    </form>
    <form action="/company_management/ReservationController?action=cancelReservation&idreservation=${RESERVATION.idreservation}&iduser=${RESERVATION.iduser}" method="post">
...
function myModifyFunction() {
	var txt;
	  if (confirm("Modify the reservation?")) {
	    txt = "Modified Successfully!";
