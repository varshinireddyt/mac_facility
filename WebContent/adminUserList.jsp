...
<form action="/company_management/UserAdminController?action=adminUserList" method="post">          
       <table border="1" class="myTable"> 
			...
			<td> <a href="/company_management/UserAdminController?action=listSpecificUser&id=${item.userId}">View</a></td>
            </tr>
		</c:forEach>
